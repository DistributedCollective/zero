...
[Home](./index.md) &gt; [@sovryn-zero/lib-base](./lib-base.md) &gt; [Decimal](./lib-base.decimal.md)
...
Used by Liquity libraries to precisely represent native currency (e.g. Ether), ZUSD and ZERO amounts, as well as derived metrics like collateral ratios.
