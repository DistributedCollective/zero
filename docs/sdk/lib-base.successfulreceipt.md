...
[Home](./index.md) &gt; [@sovryn-zero/lib-base](./lib-base.md) &gt; [SuccessfulReceipt](./lib-base.successfulreceipt.md)
...
The `details` property may contain more information about the transaction. See the return types of [TransactableLiquity](./lib-base.transactableliquity.md) functions for the exact contents of `details` for each type of Zero transaction.
