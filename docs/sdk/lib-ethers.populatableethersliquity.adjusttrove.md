...
[Home](./index.md) &gt; [@sovryn-zero/lib-ethers](./lib-ethers.md) &gt; [PopulatableEthersLiquity](./lib-ethers.populatableethersliquity.md) &gt; [adjustTrove](./lib-ethers.populatableethersliquity.adjusttrove.md)
...
The transaction will fail if the Trove's debt would fall below [ZUSD\_MINIMUM\_DEBT](./lib-base.zusd_minimum_debt.md)<!-- -->.
