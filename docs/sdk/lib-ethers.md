...
[Home](./index.md) &gt; [@sovryn-zero/lib-ethers](./lib-ethers.md)
...
|  [UnsupportedNetworkError](./lib-ethers.unsupportednetworkerror.md) | Thrown when trying to connect to a network where Zero is not deployed. |
...
|  [EthersLiquityConnection](./lib-ethers.ethersliquityconnection.md) | Information about a connection to the Zero protocol. |
