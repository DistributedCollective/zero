...
interface HintHelpersStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class HintHelpersStorage extends BaseContract {
  ...
  interface: HintHelpersStorageInterface;
