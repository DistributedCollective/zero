...
interface IActivePoolInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "ActivePoolETHBalanceUpdated(uint256)": EventFragment;
    "ActivePoolZUSDDebtUpdated(uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ActivePoolETHBalanceUpdated"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ActivePoolZUSDDebtUpdated"): EventFragment;
  getEvent(
...
export type ActivePoolETHBalanceUpdatedEvent = TypedEvent<
  [BigNumber] & { _ETH: BigNumber }
>;

export type ActivePoolZUSDDebtUpdatedEvent = TypedEvent<
...
export class IActivePool extends BaseContract {
  ...
  filters: {
    ...
    "ActivePoolETHBalanceUpdated(uint256)"(
      _ETH?: null
    ...
    "ActivePoolZUSDDebtUpdated(uint256)"(
      _ZUSDDebt?: null
