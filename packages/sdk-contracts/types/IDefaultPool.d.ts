...
interface IDefaultPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "sendETHToActivePool(uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "sendETHToActivePool",
    values: [BigNumberish]
  ): string;
  ...
  events: {
    ...
    "DefaultPoolETHBalanceUpdated(uint256)": EventFragment;
    "DefaultPoolZUSDDebtUpdated(uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "DefaultPoolETHBalanceUpdated"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "DefaultPoolZUSDDebtUpdated"): EventFragment;
...
export type DefaultPoolETHBalanceUpdatedEvent = TypedEvent<
  [BigNumber] & { _ETH: BigNumber }
>;

export type DefaultPoolZUSDDebtUpdatedEvent = TypedEvent<
  [BigNumber] & { _ZUSDDebt: BigNumber }
>;
...
export class IDefaultPool extends BaseContract {
  ...
  filters: {
    ...
    "DefaultPoolETHBalanceUpdated(uint256)"(
      _ETH?: null
    ): TypedEventFilter<[BigNumber], { _ETH: BigNumber }>;

    DefaultPoolETHBalanceUpdated(
      _ETH?: null
    ): TypedEventFilter<[BigNumber], { _ETH: BigNumber }>;

    "DefaultPoolZUSDDebtUpdated(uint256)"(
      _ZUSDDebt?: null
    ): TypedEventFilter<[BigNumber], { _ZUSDDebt: BigNumber }>;

    DefaultPoolZUSDDebtUpdated(
      _ZUSDDebt?: null
    ): TypedEventFilter<[BigNumber], { _ZUSDDebt: BigNumber }>;
