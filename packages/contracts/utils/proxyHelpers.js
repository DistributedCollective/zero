...
class BorrowerWrappersProxy extends Proxy {
  ...
  async transferRBTC(...params) {
    return this.forwardFunction(params, 'transferRBTC(address,uint256)')
  }
}
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingRBTCReward(...params) {
    return this.proxyFunction('getPendingRBTCReward', params)
  }
  ...
  async L_RBTC() {
    return this.proxyFunction('L_RBTC', [])
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getDepositorRBTCGain(user) {
    return this.proxyFunctionWithUser('getDepositorRBTCGain', user)
  }
}
