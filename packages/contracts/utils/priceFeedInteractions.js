...
//    // Set the LoC Manager address in the testnet PriceFeed
//     // const res = await testnetPriceFeed.setLoCManagerAddress('0x405143dAe9a8a703a1fE82ad4B65BBFE5505AF63')
//     // res.wait()
//     const recordedLoCManagerAddressTestnet = await testnetPriceFeed.locManagerAddress()
//     console.log(`recorded LoCManager Address is ${recordedLoCManagerAddressTestnet}`)
...
//     console.log(`Testnet: Latest BTC:USD price from aggregator: ${price_aggregatorTestnet}`);
...
//     console.log(`Testnet: Latest BTC:USD price from deployed PriceFeed: ${price_PriceFeedTestnet}`)
...
//     console.log(`Mainnet: Latest BTC:USD price from aggregator: ${price_aggregatorMainnet}`);
...
//     console.log(`Mainnet: Latest BTC:USD price from deployed PriceFeed: ${price_PriceFeedMainnet}`)
...
//     Therefore, expected gas cost of a getLatestPrice() call is within a LoC function is (35k - 27.5k) 
