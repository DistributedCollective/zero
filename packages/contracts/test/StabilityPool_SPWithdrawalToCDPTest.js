...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawBTCGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and BTC Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BTC
      ...
      const txA = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: alice })
      const txB = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: bob })
      const txC = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: carol })
    ...
    it("withdrawBTCGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and BTC Gain after two identical liquidations", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove():  Depositors with equal initial deposit withdraw correct compounded deposit and BTC Gain after three identical liquidations", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and BTC Gain after two liquidations of increasing ZUSD", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and BTC Gain after three liquidations of increasing ZUSD", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and BTC Gain after two identical liquidations", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and BTC Gain after three identical liquidations", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and BTC Gain after three varying liquidations", async () => {
      // Whale opens Trove with 1m BTC
    ...
    it("withdrawBTCGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 ZUSD.  A, B, C, D withdraw correct ZUSD deposit and BTC Gain", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      ...
      const txB = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: bob })
      const txC = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: carol })
      const txD = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: dennis })
    ...
    it("withdrawBTCGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 ZUSD.  A, B, C, D withdraw correct ZUSD deposit and BTC Gain", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct ZUSD deposit and BTC Gain", async () => {
      // Whale opens Trove with 1m BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(1000000, 18)), whale, whale, { from: whale, value: dec(1000000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 ZUSD.  A, B, C, D withdraw correct ZUSD deposit and BTC Gain", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct ZUSD deposit and BTC Gain", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 ZUSD. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct ZUSD deposit and BTC Gain", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Pool-emptying liquidation increases epoch by one, resets scaleFactor to 0, and resets P to 1e18", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      ...
      const txC = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: carol })
      const txD = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: dennis })
      const txE = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: erin })
    ...
    it("withdrawBTCGainToTrove(): single deposit fully offset. After subsequent liquidations, depositor withdraws 0 deposit and *only* the BTC Gain from one liquidation", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      const txD = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: dennis })
      const txE = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: erin })
      const txF = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: flyn })
      const txG = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: graham })
      const txH = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: harriet })
    ...
    it("withdrawBTCGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and BTC Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    // expect d(B) = d0(B)/100
    // expect correct BTC gain, i.e. all of the reward
    it("withdrawBTCGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and BTC Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    // expect d(B) = d0(B) * 1e-5
    // expect B gets entire BTC gain from L2
    it("withdrawBTCGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and BTC Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    */
    it("withdrawBTCGainToTrove(): Several deposits of 10000 ZUSD span one scale factor change. Depositors withdraws correct compounded deposit and BTC Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      ...
      // Increasing the price for a moment to avoid pending liquidations to block withdrawal
      await priceFeed.setPrice(dec(200, 18))
      const txA = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: A })
      const txB = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: B })
      await priceFeed.setPrice(dec(100, 18))
      ...
      // Increasing the price for a moment to avoid pending liquidations to block withdrawal
      await priceFeed.setPrice(dec(200, 18))
      const txC = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: C })
      const txD = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: D })
      await priceFeed.setPrice(dec(100, 18))
      ...
      // Attempt withdrawals
      const txE = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: E })
      const txF = await stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: F })
    ...
    it("withdrawBTCGainToTrove(): Large liquidated coll/debt, deposits and BTC price", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawBTCGainToTrove(): Small liquidated coll/debt, large deposits and BTC price", async () => {
      // Whale opens Trove with 100k BTC
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveZUSDAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      ...
      // Defaulter opens trove with 50e-7 BTC and  5000 ZUSD. 200% ICR
      ...
      const txAPromise = stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: alice })
      const txBPromise = stabilityPool.withdrawBTCGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, { from: bob })
