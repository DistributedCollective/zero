...
contract('StabilityPool - ZERO Rewards', async accounts => {
  ...
  describe("ZERO Rewards", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct ZERO gain. No liquidations. No front end.", async () => {
      ...
      // Whale opens Trove with 10k RBTC
    ...
    1 month passes. L1 decreases P: P = 1e-5 P. L1:   9999.9 ZUSD, 100 RBTC
    B makes deposit 9999.9
    1 month passes. L2 decreases P: P =  1e-5 P. L2:  9999.9 ZUSD, 100 RBTC
    C makes deposit  9999.9
    1 month passes. L3 decreases P: P = 1e-5 P. L3:  9999.9 ZUSD, 100 RBTC
    D makes deposit  9999.9
    1 month passes. L4 decreases P: P = 1e-5 P. L4:  9999.9 ZUSD, 100 RBTC
    E makes deposit  9999.9
    1 month passes. L5 decreases P: P = 1e-5 P. L5:  9999.9 ZUSD, 100 RBTC
    =========
    F makes deposit 100
    1 month passes. L6 empties the Pool. L6:  10000 ZUSD, 100 RBTC
    ...
    it("withdrawFromSP(): Several deposits of 100 ZUSD span one scale factor change. Depositors withdraw correct ZERO gains", async () => {
      // Whale opens Trove with 100 RBTC
    ...
    1 month passes. L1 depletes P: P = 1e-5*P L1:  9999.9 ZUSD, 1 RBTC.  scale = 0
    C makes deposit 10000  via F1
    1 month passes. L2 depletes P: P = 1e-5*P L2:  9999.9 ZUSD, 1 RBTC  scale = 1
    D makes deposit 10000 via F1
    1 month passes. L3 depletes P: P = 1e-5*P L3:  9999.9 ZUSD, 1 RBTC scale = 1
    E makes deposit 10000 via F1
    1 month passes. L3 depletes P: P = 1e-5*P L4:  9999.9 ZUSD, 1 RBTC scale = 2
    A, B, C, D, E withdraw
