...
contract("TroveManager", async (accounts) => {
   ...
   (because his pending rewards bring his ICR < MCR) */
    ...
    it("redeemCollateral(): reverts if max fee < 2.5%", async () => {
        ...
        await assertRevert(
            th.redeemCollateralAndGetTxObject(A, contracts, dec(10, 18), "24999999999999999"),
            "Max fee percentage must be between 2.5% and 100%"
        );
    });
    ...
    it("redeemCollateral(): reverts if fee exceeds max fee percentage", async () => {
        ...
        // Max fee is 2.5%
        await assertRevert(
            th.redeemCollateralAndGetTxObject(A, contracts, attemptedZUSDRedemption, dec(25, 15)),
            "Fee exceeded provided maximum"
        );
    });
