...
import "./LoCManagerBase1MinuteBootstrap.sol";

contract LoCManagerRedeemOpsTestnet is LoCManagerBase1MinuteBootstrap {
    ...
    function _isValidFirstRedemptionHint(
        ...
        return
            nextLoC == address(0) || _getCurrentICR(nextLoC, _price) < zeroBaseParams.MCR();
    }
