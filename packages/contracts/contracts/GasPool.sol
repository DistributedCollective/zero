 ...
 * When a borrower opens a loc, an additional 50 ZUSD debt is issued,
 * and 50 ZUSD is minted and sent to this contract.
 * When a borrower closes their active loc, this gas compensation is refunded:
 * 50 ZUSD is burned from the this contract's balance, and the corresponding
 * 50 ZUSD debt on the LoC is cancelled.
