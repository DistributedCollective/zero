...
interface IStabilityPool {
    ...
    */
     ...
     */
    function withdrawRBTCGainToTrove(address _upperHint, address _lowerHint) external;
    ...
    /**
     * @notice Calculates the RBTC gain earned by the deposit since its last snapshots were taken.
     * @param _depositor address to calculate RBTC gain
     * @return RBTC gain from given depositor
     */
