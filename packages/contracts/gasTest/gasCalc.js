...
contract('Gas cost tests', async accounts => {
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 0 existing Troves in system. Adds 10 ether and issues 100 ZUSD'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 1 existing Trove in system. Adds 10 ether and issues 100 ZUSD'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, Inserts between 2 existing CDs in system. Adds 10 ether and issues 80 ZUSD. '
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues 100 ZUSD'

  //   const amountRBTC = dec(10, 'ether')
  //   const amountZUSD = 0
  //   const gasResults = await th.openTrove_allAccounts(_10_Accounts, contracts, amountRBTC, amountZUSD)
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues less ZUSD than the previous one'
  //   const amountRBTC = dec(10, 'ether')
  //   const amountZUSD = 200
  //   const gasResults = await th.openTrove_allAccounts_decreasingZUSDAmounts(_10_Accounts, contracts, amountRBTC, amountZUSD)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'openTrove(), 50 accounts, each account adds random ether and random ZUSD'
    const amountRBTC = dec(10, 'ether')
    const amountZUSD = 0
    const gasResults = await th.openTrove_allAccounts_randomRBTC_randomZUSD(1, 9, _50_Accounts, contracts, 2, 100, true)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). RBTC/ZUSD Increase/Increase. 10 accounts, each account adjusts up -  1 ether and 100 ZUSD'
  ...
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, amountRBTC, amountZUSD)


  //   const amountRBTC_2 = dec(1, 'ether')
  //   const amountZUSD_2 = dec(100, 18)
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountRBTC_2, amountZUSD_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). RBTC/ZUSD Decrease/Decrease. 10 accounts, each account adjusts down by 0.1 ether and 10 ZUSD'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). RBTC/ZUSD Increase/Decrease. 10 accounts, each account adjusts up by 0.1 ether and down by 10 ZUSD'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountRBTC = dec(10, 'ether')
  //   const amountZUSD = dec(100, 18)
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, amountRBTC, amountZUSD)

  //   // Randomly add between 1-9 RBTC, and withdraw 1-100 ZUSD
  ...
  it("", async () => {
    ...
    const amountZUSD = dec(100, 18)
    await th.openTrove_allAccounts(_40_Accounts, contracts, amountRBTC, amountZUSD)
    // Randomly add between 1-9 RBTC, and withdraw 1-100 ZUSD
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts_decreasingZUSDAmounts(_10_Accounts, contracts, dec(10, 'ether'), 200)
  ...
  it("", async () => {
    const message = 'closeTrove(), 20 accounts, each account adds 10 ether and issues less ZUSD than the previous one. First 10 accounts close their trove. '

    await th.openTrove_allAccounts_decreasingZUSDAmounts(_20_Accounts, contracts, dec(10, 'ether'), 200)
  ...
  it("", async () => {
    const message = 'withdrawZUSD(), first withdrawal, 30 accounts, each account withdraws a random ZUSD amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)

    const gasResults = await th.withdrawZUSD_allAccounts_randomAmount(1, 180, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'withdrawZUSD(), second withdrawal, 30 accounts, each account withdraws a random ZUSD amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_30_Accounts, contracts, dec(100, 18))

    const gasResults = await th.withdrawZUSD_allAccounts_randomAmount(1, 70, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'repayZUSD(), partial repayment, 30 accounts, repay random amount of ZUSD (of 100 ZUSD)'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawZUSD(_100pct, randZUSDAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and 100 ZUSD withdrawn'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and random ZUSD amount withdrawn'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  ...
  it("", async () => {
    ...
    const randZUSDAmount = th.randAmountInWei(1, 180)
    await borrowerOperations.openTrove(_100pct, randZUSDAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(10, 'ether') })
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and 100 ZUSD withdrawn, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(100, 18))
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and random ZUSD amount withdrawn, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(100, 18))
  ...
  // --- redeemCollateral() ---
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove. One account in system, partial redemption'
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less ZUSD
    await borrowerOperations.withdrawZUSD(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(90, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(80, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })

    /* Account 2 redeems 50 ZUSD. It is redeemed from account 0's Trove, 
    leaving the Trove active with 30 ZUSD and ((200 *10 - 50 ) / 200 ) = 9.75 RBTC. 
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 101 ZUSD, redemption hits 2 Troves, last redemption is partial'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 500 ZUSD, redeems 101 ZUSD
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawZUSD(_100pct, dec(500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 ZUSD, redemption hits 5 Troves, all full redemptions'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 500 ZUSD, redeems 500 ZUSD
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawZUSD(_100pct, dec(500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 450 ZUSD, redemption hits 5 Troves,  last redemption is partial (50 of 100 ZUSD)'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 450 ZUSD, redeems 500 ZUSD
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawZUSD(_100pct, dec(450, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1000 ZUSD, redemption hits 10 Troves'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 1000 ZUSD, redeems 500 ZUSD
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawZUSD(_100pct, dec(1000, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1500 ZUSD, redemption hits 15 Troves'
    ...
    // Whale adds 200 ether, withdraws 1500 ZUSD, redeems 1500 ZUSD
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawZUSD(_100pct, dec(1500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 2000 ZUSD, redemption hits 20 Troves'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_30_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 2000 ZUSD, redeems 2000 ZUSD
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawZUSD(_100pct, dec(2000, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  // it("", async () => { 
  //   const message = 'redeemCollateral(),  ZUSD, each redemption only hits the first Trove, never closes it'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawZUSD_allAccounts(_20_Accounts, troveManager, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove, WITH pending rewards. One account in system'
    await th.openTrove_allAccounts([accounts[1]], contracts, dec(10, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(100, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })

    // acct 998 adds coll, withdraws ZUSD, sits at 111% ICR
    await th.openTrove_allAccounts([accounts[998]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[998], ZERO_ADDRESS, { from: accounts[998] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less ZUSD
    await borrowerOperations.withdrawZUSD(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 ZUSD, WITH pending rewards, redemption hits 5 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1000 ZUSD, WITH pending rewards, redemption hits 10 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1500 ZUSD, WITH pending rewards, redemption hits 15 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_20_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 2000 ZUSD, WITH pending rewards, redemption hits 20 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  // it("", async () => { 
  //   const message = 'redeemCollateral(),  ZUSD, each redemption only hits the first Trove, never closes it, WITH pending rewards'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawZUSD_allAccounts(_20_Accounts, troveManager, dec(100, 18))
  ...
  //   await th.withdrawZUSD_allAccounts_randomAmount(1, 180, _10_Accounts, troveManager)
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 ZUSD, all make first deposit, random ZUSD amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, deposit part of issued ZUSD: all accounts withdraw 180 ZUSD, all make second deposit, provide 50 ZUSD'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 ZUSD, make second deposit, random ZUSD amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(130, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  //   // 9 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 50 ZUSD to Stability Pool
  ...
  //   //1 acct open Trove with 1 ether and withdraws 170 ZUSD
  ...
  //   // 9 active Troves top up their Stability Pool deposits with 50 ZUSD
  ...
  //   // 10 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 90 ZUSD to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawZUSD_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 ether and withdraws 180 ZUSD
  //   await borrowerOperations.openTrove(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(1, 'ether') })
  ...
  //   // 5 active Troves top up their Stability Pool deposits with 90 ZUSD, using up all their issued ZUSD
  ...
  it("", async () => {
    const message = 'provideToSP(), with pending rewards in system. deposit part of issued ZUSD: all make second deposit, provide random ZUSD amount'
    // 10 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 90 ZUSD to Stability Pool
    ...
    // 5 active Troves top up their Stability Pool deposits with a random ZUSD amount
  ...
  // full
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make full withdrawal - 130 ZUSD of 130 ZUSD deposit'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(190, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(130, 18))
  ...
  // random amount
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - random ZUSD amount, less than 180 ZUSD deposit'
  ...
  //   // 10 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 180 ZUSD to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  ...
  //   // 5 active Troves reduce their Stability Pool deposit by 90 ZUSD
  ...
  it("", async () => {
    const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make full withdrawal - 130 ZUSD of 130 ZUSD deposit'
    // 10 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 180 ZUSD to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
    ...
    // 5 active Troves reduce their Stability Pool deposit by 130 ZUSD
  ...
  it("", async () => {
    const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - random amount of ZUSD'
    // 10 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 130 ZUSD to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  // --- withdrawRBTCGainToTrove() - deposit has pending rewards ---
  // it("", async () => {
  //   const message = 'withdrawRBTCGainToTrove(), pending rewards in system. Accounts withdraw 180 ZUSD, provide 180 ZUSD, then withdraw all to SP after a liquidation'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 130 ZUSD to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  //   // 5 active Troves withdraw their RBTC gain to their trove
  //   const gasResults = await th.withdrawRBTCGainToTrove_allAccounts(accounts.slice(7, 12), contracts)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'withdrawRBTCGainToTrove(), pending rewards in system. Accounts withdraw 180 ZUSD, provide a random amount, then withdraw all to SP after a liquidation'
    // 20 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 180 ZUSD to Stability Pool
    ...
    // 5 active Troves withdraw their RBTC gain to their trove
    const gasResults = await th.withdrawRBTCGainToTrove_allAccounts(accounts.slice(2, 22), contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 180 ZUSD
    ...
    //6s acct open Trove with 1 ether and withdraw 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    ...
    // 100 accts each open Trove with 10 ether, withdraw 180 ZUSD
    ...
    // Accts open Trove with 1 ether and withdraws 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    ...
    //2 acct open Trove with 1 ether and withdraws 180 ZUSD (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(2, 4), contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
  ...
  it("", async () => {
    ...
    //3 acct open Trove with 1 ether and withdraws 180 ZUSD (inc gas comp)
    ...
    await borrowerOperations.withdrawZUSD(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  it("", async () => {
    ...
    // 5 acct open Trove with 1 ether and withdraws 180 ZUSD (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(0, 5), contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[4], ZERO_ADDRESS, { from: accounts[4] })
  ...
  it("", async () => {
    ...
    //4 acct open Trove with 1 ether and withdraws 180 ZUSD (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(0, 4), contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
  ...
  it("", async () => {
    ...
    //Account 99 and 98 each open Trove with 1 ether, and withdraw 180 ZUSD (inc gas comp)
    await th.openTrove_allAccounts([accounts[99]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[99], ZERO_ADDRESS, { from: accounts[99] })
    await th.openTrove_allAccounts([accounts[98]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[98], ZERO_ADDRESS, { from: accounts[98] })

    // Acct 99 deposits 1 ZUSD to SP
    await stabilityPool.provideToSP(dec(1, 18), ZERO_ADDRESS, { from: accounts[99] })

    //Account 97 opens Trove with 1 ether and withdraws 180 ZUSD (inc gas comp)
    await th.openTrove_allAccounts([accounts[97]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[97], ZERO_ADDRESS, { from: accounts[97] })

    // Acct 100 withdraws 1800 ZUSD and deposits it to the SP
    await borrowerOperations.withdrawZUSD(_100pct, dec(1750, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  // pure offset
  it("", async () => {
    const message = 'liquidate() 1 Trove Normal Mode, 30 active Troves, no RBTC gain in pool, pure offset with SP'
    // 30 accts each open Trove with 10 ether, withdraw 180 ZUSD, and provide 180 ZUSD to Stability Pool
    ...
    //1 acct open Trove with 1 ether and withdraws 180 ZUSD (inc gas comp)
