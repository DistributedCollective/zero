...
contract("Gas cost tests", async accounts => {
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 0 existing Troves in system. Adds 10 bitcoin and issues 100 ZUSD'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 1 existing Trove in system. Adds 10 bitcoin and issues 100 ZUSD'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, Inserts between 2 existing CDs in system. Adds 10 bitcoin and issues 80 ZUSD. '
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 bitcoin and issues 100 ZUSD'

  //   const amountBTC = dec(10, 'ether')
  //   const amountZUSD = 0
  //   const gasResults = await th.openTrove_allAccounts(_10_Accounts, contracts, amountBTC, amountZUSD)
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 bitcoin and issues less ZUSD than the previous one'
  //   const amountBTC = dec(10, 'ether')
  //   const amountZUSD = 200
  //   const gasResults = await th.openTrove_allAccounts_decreasingZUSDAmounts(_10_Accounts, contracts, amountBTC, amountZUSD)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = "openTrove(), 50 accounts, each account adds random bitcoin and random ZUSD";
    const amountBTC = dec(10, "ether");
    const amountZUSD = 0;
    const gasResults = await th.openTrove_allAccounts_randomBTC_randomZUSD(
      1,
      9,
      _50_Accounts,
      contracts,
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). BTC/ZUSD Increase/Increase. 10 accounts, each account adjusts up -  1 bitcoin and 100 ZUSD'
  ...
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, amountBTC, amountZUSD)

  //   const amountBTC_2 = dec(1, 'ether')
  //   const amountZUSD_2 = dec(100, 18)
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountBTC_2, amountZUSD_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). BTC/ZUSD Decrease/Decrease. 10 accounts, each account adjusts down by 0.1 bitcoin and 10 ZUSD'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). BTC/ZUSD Increase/Decrease. 10 accounts, each account adjusts up by 0.1 bitcoin and down by 10 ZUSD'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountBTC = dec(10, 'ether')
  //   const amountZUSD = dec(100, 18)
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, amountBTC, amountZUSD)
  ...
  it("", async () => {
    ...
    const amountZUSD = dec(100, 18);
    await th.openTrove_allAccounts(_40_Accounts, contracts, amountBTC, amountZUSD);
    // Randomly add between 1-9 BTC, and withdraw 1-100 ZUSD
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts_decreasingZUSDAmounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
      200
  ...
  it("", async () => {
    const message =
      "closeTrove(), 20 accounts, each account adds 10 bitcoin and issues less ZUSD than the previous one. First 10 accounts close their trove. ";
  ...
  it("", async () => {
    const message = "getCurrentICR(), new Troves with 10 bitcoin and no withdrawals";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
  ...
  it("", async () => {
    const message = "getCurrentICR(), Troves with 10 bitcoin and 100 ZUSD withdrawn";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message = "getCurrentICR(), Troves with 10 bitcoin and random ZUSD amount withdrawn";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
  ...
  it("", async () => {
    ...
    const randZUSDAmount = th.randAmountInWei(1, 180);
    await borrowerOperations.openTrove(_100pct, randZUSDAmount, accounts[1], ZERO_ADDRESS, {
      from: accounts[1],
      value: dec(10, "ether")
    });
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), new Troves with 10 bitcoin and no withdrawals,  WITH pending rewards";
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 bitcoin and 100 ZUSD withdrawn, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), dec(100, 18));
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 bitcoin and random ZUSD amount withdrawn, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove. One account in system, partial redemption";
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption";
    // 3 accounts add coll
    ...
    leaving the Trove active with 30 ZUSD and ((200 *10 - 50 ) / 200 ) = 9.75 BTC. 
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 101 ZUSD, redemption hits 2 Troves, last redemption is partial";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 500 ZUSD, redemption hits 5 Troves, all full redemptions";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 450 ZUSD, redemption hits 5 Troves,  last redemption is partial (50 of 100 ZUSD)";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove, WITH pending rewards. One account in system";
    await th.openTrove_allAccounts([accounts[1]], contracts, dec(10, "ether"), 0);
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 ZUSD, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.";
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, "ether"), 0);
    // 3 accounts withdraw successively less ZUSD
    await borrowerOperations.withdrawZUSD(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, {
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 500 ZUSD, WITH pending rewards, redemption hits 5 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1000 ZUSD, WITH pending rewards, redemption hits 10 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1500 ZUSD, WITH pending rewards, redemption hits 15 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_20_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 2000 ZUSD, WITH pending rewards, redemption hits 20 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawZUSD_allAccounts(_30_Accounts, contracts, dec(100, 18));
  ...
  //   // 9 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD, and provide 50 ZUSD to Stability Pool
  ...
  //   //1 acct open Trove with 1 bitcoin and withdraws 170 ZUSD
  ...
  //   // 10 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD, and provide 90 ZUSD to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawZUSD_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 bitcoin and withdraws 180 ZUSD
  //   await borrowerOperations.openTrove(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(1, 'ether') })
  ...
  //   // 10 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD, and provide 180 ZUSD to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD, and provide 130 ZUSD to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, "ether"), dec(130, 18));
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18));
  ...
  // --- withdrawBTCGainToTrove() - deposit has pending rewards ---
  // it("", async () => {
  //   const message = 'withdrawBTCGainToTrove(), pending rewards in system. Accounts withdraw 180 ZUSD, provide 180 ZUSD, then withdraw all to SP after a liquidation'
  //   // 10 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD, and provide 130 ZUSD to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  //   // 5 active Troves withdraw their BTC gain to their trove
  //   const gasResults = await th.withdrawBTCGainToTrove_allAccounts(accounts.slice(7, 12), contracts)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message =
      "withdrawBTCGainToTrove(), pending rewards in system. Accounts withdraw 180 ZUSD, provide a random amount, then withdraw all to SP after a liquidation";
    // 20 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD, and provide 180 ZUSD to Stability Pool
    ...
    // 5 active Troves withdraw their BTC gain to their trove
    const gasResults = await th.withdrawBTCGainToTrove_allAccounts(accounts.slice(2, 22), contracts);
    th.logGasMetrics(gasResults, message);
    th.logAllGasCosts(gasResults);
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD
    ...
    //6s acct open Trove with 1 bitcoin and withdraw 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    ...
    // 100 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD
    ...
    // Accts open Trove with 1 bitcoin and withdraws 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    ...
    //2 acct open Trove with 1 bitcoin and withdraws 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    ...
    //3 acct open Trove with 1 bitcoin and withdraws 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    ...
    // 5 acct open Trove with 1 bitcoin and withdraws 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    ...
    //4 acct open Trove with 1 bitcoin and withdraws 180 ZUSD (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(0, 4), contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawZUSD(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1]
    });
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 bitcoin
    await th.openTrove_allAccounts(accounts.slice(100, 110), contracts, dec(10, "ether"), 0);

    //Account 99 and 98 each open Trove with 1 bitcoin, and withdraw 180 ZUSD (inc gas comp)
    ...
    //Account 97 opens Trove with 1 bitcoin and withdraws 180 ZUSD (inc gas comp)
  ...
  it("", async () => {
    const message =
      "liquidate() 1 Trove Normal Mode, 30 active Troves, no BTC gain in pool, pure offset with SP";
    // 30 accts each open Trove with 10 bitcoin, withdraw 180 ZUSD, and provide 180 ZUSD to Stability Pool
    ...
    //1 acct open Trove with 1 bitcoin and withdraws 180 ZUSD (inc gas comp)
