...
contract("Gas cost tests", async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 ZUSD
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 ZUSD
    await th.openTrove_allAccounts(
      accounts.slice(101, 111),
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 ZUSD
    const _2_Defaulters = accounts.slice(1, 3);
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, "ether"), dec(60, 18));
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 ZUSD
