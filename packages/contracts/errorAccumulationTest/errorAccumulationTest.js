...
contract('TroveManager', async accounts => {
  ...
  it("11 accounts with random coll. 1 liquidation. 10 accounts do Trove operations (apply rewards)", async () => {
    ...
    await th.openTrove_allAccounts_randomRBTC(1, 2, accounts.slice(1, 10), contracts, dec(170, 18))
  ...
  */
  ...
  it("101 accounts with random coll. 1 liquidation. 100 accounts do a Trove operation (apply rewards)", async () => {
    ...
    await th.openTrove_allAccounts_randomRBTC(1, 2, accounts.slice(1, 100), contracts, dec(170, 18))
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const totalRBTCRewards = (totalColl.mul(L_RBTC)).div(_1e18_BN)
 ...
 it("11 accounts with random RBTC and proportional ZUSD (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })

  await th.openTrove_allAccounts_randomRBTC_ProportionalZUSD(1, 2, accounts.slice(0, 11), contracts, 180)
  ...
  */
  ...
  it("101 accounts with random RBTC and proportional ZUSD (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(1000, 'ether') })

    await th.openTrove_allAccounts_randomRBTC_ProportionalZUSD(1, 2, accounts.slice(0, 101), contracts, 180)
  ...
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
   // Acct 99 opens trove with 100 ZUSD
    ...
    const _1e18_BN = web3.utils.toBN(dec(1, 18))
    const totalRBTCRewards_Distribution = (totalColl.mul(L_RBTC)).div(_1e18_BN)
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    /* Sometimes, the error causes the last ZUSD withdrawal from SP to underflow and fail. 
...
it("11 accounts with random large coll, magnitude ~1e8 ether. 1 liquidation. 10 accounts do Trove operations (apply rewards)", async () => {
  ...
  await th.openTrove_allAccounts_randomRBTC(100000000, 200000000, accounts.slice(1, 10), contracts, dec(170, 18))
...
it("101 accounts with random large coll, magnitude ~1e8 ether. 1 liquidation. 500 accounts do a Trove operation (apply rewards)", async () => {
  ...
  await borrowerOperations.openTrove(0, dec(170, 18), accounts[0], { from: accounts[0], value: dec(1, 'ether') })
   ...
   // Troves open with 100-200 million ether
  await th.openTrove_allAccounts_randomRBTC(100000000, 200000000, accounts.slice(1, 100), contracts, dec(170, 18))
...
it("11 accounts with random RBTC and proportional ZUSD (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  ...
  await th.openTrove_allAccounts_randomRBTC_ProportionalZUSD(100000000, 200000000, accounts.slice(0, 11), contracts, 180)
...
/* 
  ...
  */
  ...
  it("101 accounts with random RBTC and proportional ZUSD (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    ...
    // Troves open with 100-200 million ether and proportional ZUSD Debt
    await th.openTrove_allAccounts_randomRBTC_ProportionalZUSD(100000000, 200000000, accounts.slice(0, 101), contracts, 180)
 ...
 Test to see if error is stable or grows. 
  ...
  1) Reward applications accumulate RBTC and ZUSDDebt error in DefaultPool

  2) Liquidations accumulate RBTC and ZUSDDebt error in DefaultPool
