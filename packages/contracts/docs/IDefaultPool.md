...
View Source: [contracts/Interfaces/IDefaultPool.sol](../contracts/Interfaces/IDefaultPool.sol)

**↗ Extends: [IPool](IPool.md)**
**↘ Derived Contracts: [DefaultPool](DefaultPool.md)**
